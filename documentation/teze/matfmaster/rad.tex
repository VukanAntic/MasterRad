...
\item Izrada klijenta zasnovanog na MVC arhitekturi \cite{fowler-mvc} - U glavi 4 prikazano je kako je implementiran klijentski deo koda koji prati MVC arhitekturu i dodatne funkcionalnosti koje klijent podržava kao što je viđet (eng. \textit{widget}).
...
sa informacijama ko je bio autor, naziv slike, i za koji datum je slika namenjena, i onda viđet može 
