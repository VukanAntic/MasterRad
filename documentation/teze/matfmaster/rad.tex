...
Klijent je realizovan u tehnologiji (eng. \textit{React Native}) uz radni okriv (eng. \textit{Expo}). Svaka od komponenti klijenta 
je implementirana po model-prikaz-kontroler (eng. \textit{Model-View-Controller}) arhitekturi. U narednoj glavi biće prikazano kako su izgrađene komponente kao i 
...
Čitav klijent razvijen je u programskom jeziku TypeScript, uz radni okvir
(eng. \textit{framework}) \textit{React Native} \cite{reactnative}. React Native
je nadogradnja nad bibliotekom \textit{React}, uz motivaciju da se iz istog
...
Prikaz-Kontroler arhitektura \textit{Model-View-Controller}) predstavlja standard za pravljenje komponenti u klijentskim aplikacija.
...
TODO koje sve tipove repoa postoje
TODO widget
