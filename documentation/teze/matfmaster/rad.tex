...
\subsection{Prikaz}
Prikaz je zadužen za sve komponente koje se izcrtavaju na ekranu telefona.
...
prikazu, citav prikaz se opet iscrtava. Želja za ovim pristupom jeste da je sve prikazano na ekranu uvek ispravo stanje 
...
Oni se razlikuju od entiteta koji su poslati od strane servera. Ideja jeste za model ima samo informacije 
koje su potrebne prikazu da vrši svoju dužnost. Model nema informaciju o samom prikazu kao ni kontroleru. On 
je samo klasa koja predstavljaju prenos podataka.

\subsection{Kontroler}
Kontrolerova funkcija je da se bavi biznis logikom vezanu za prikaz. Ona sadrži referencu na svoj prikaz,
...
\section{Namera}
Prikaz nema informaciju o postojanju kontrolera, jedini način da prikaz komunicira sa spoljasnjim
...
Repozitorijum \cite{fowler2002} u klijentskom kontekstu podrazumeva čuvanja trenutnog stanja aplikacije u memoriji. Unutar repozitorijuma 
...
Sva tri metoda su asihrone prirode, iako za jednostavno čuvanje u memoriji to nije potrebno. Razlog je jer u određenim situacijama,
potrebno je takođe čuvanje informacija između različitih korisničkih sesija, a čuvanje u skladište uređaja je asihrona akcija.
...
kasnije kontroler čita. Kontroler ne poziva server direktno, već koristi rukovodilac da izvršavi komandu. 
...
informacija od servera vezano za sve žanrove koje server podržava. On ne implementira ni jedan konrektan protokol komunikacije, 
